...
class DatasetAcquisition:
    ...
    def download_huggingface_dataset(
        self, dataset_name: str, task_type: str
    ) -> List[Dict[str, Any]]:
        """
                    ...
                    json.dumps(
                        {
                            "call_to_action": True,
                            "action_type": "remind",
                            "remind": {"time": "2024-01-01T15:00:00", "description": "call John"},
                        }
                    ),
                ),
                (
                    ...
                    json.dumps(
                        {
                            ...
                            "schedule": {
                                "start_time": "2024-01-05T19:00:00",
                                "end_time": "2024-01-05T21:00:00",
...
def main():
    ...
    parser.add_argument(
        "--task",
        choices=["command", "extraction", "both"],
        default="both",
