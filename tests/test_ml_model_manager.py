...
from ml_model_manager import MLModelManager, MLModelManager, ModelResponse
...
class TestMLModel:
    ...
    def test_init_with_valid_model(self, mock_get):
        ...
        # Test initialization
        model = MLModelManager("microsoft/DialoGPT-small")
    ...
    def test_init_with_custom_system_prompt(self, mock_get):
        ...
        model = MLModelManager("test-model", system_prompt=custom_prompt)
    ...
    def test_init_with_config_options(self, mock_get):
        ...
        model = MLModelManager("test-model", temperature=0.7, max_tokens=100, custom_param="value")
    ...
    def test_get_available_models_failure(self, mock_get):
        ...
        with pytest.raises(requests.RequestException):
            MLModelManager.get_available_models()
    ...
    def test_run_inference_success(self, mock_post, mock_get):
        ...
        model = MLModelManager("test-model")
